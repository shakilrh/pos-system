...
export default function Products({
  ...
  return (
      <div
          className={`lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 border border-gray-200 dark:border-gray-700 h-full relative transition-opacity duration-300 ${
              isFormActive ? 'opacity-50 pointer-events-none' : ''
          }`}
      >
        <div
            className="absolute inset-0 z-10 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-y-auto"
            style={{display: formMode ? 'block' : 'none'}}>
        ...
        <div className="relative z-0" style={{opacity: formMode ? 0.5 : 1, pointerEvents: formMode ? 'none' : 'auto'}}>
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Filter by
              Category</label>
            <select
          ...
          {currentProducts.length > 0 ? (
              ...
              <div
                  className="text-center py-8 text-gray-500 dark:text-gray-400">{gridErrorMessage || 'No products available'}</div>
          )}
          ...
          {totalProductPages > 1 && (
              <div className="flex justify-between items-center mt-4 px-4">
                ...
                <span
                    className="text-sm text-gray-600 dark:text-gray-300">Page {currentProductPage} of {totalProductPages}</span>
                <button
                ...
                <div className="p-4">
                  <div className="mb-4">
                    {selectedProduct.pictureUrl ? (
                        ...
                        <div
                            className="w-full h-48 flex items-center justify-center bg-gray-200 dark:bg-gray-600 rounded-lg">
