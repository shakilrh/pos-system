...
const MAIN_PAGES = [
  ...
  },
  {
    ...
    subPermissions: [
      ...
      { key: 'manage_users', name: 'Manage Users', description: 'Manage user accounts' },
      { key: 'manage_roles', name: 'Manage Roles', description: 'Manage roles' },
      { key: 'manage_permissions', name: 'Manage Permissions', description: 'Manage permissions' },
    ],
  },
  {
    ...
    subPermissions: [
      ...
      { key: 'manage_tables', name: 'Manage Tables', description: 'Manage tables' },
      { key: 'manage_floors', name: 'Manage Floors', description: 'Manage floors' },
