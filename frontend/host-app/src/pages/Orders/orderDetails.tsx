        ...
        {createdOrder && (
            <div className="flex gap-4 mt-6">
              <button
                  ...
                  className="flex-1 px-4 py-2 rounded-lg font-semibold flex items-center justify-center gap-2 text-sm transition-all duration-200 bg-[var(--primary-color)] text-[var(--text-on-primary)] hover:brightness-90"
              >
              ...
              <button
                  ...
                  className="flex-1 px-4 py-2 rounded-lg font-semibold text-sm bg-[var(--background-secondary)] text-[var(--text-secondary)] hover:bg-[var(--surface-secondary)] transition-all duration-200"
              >
                Clear Order
              </button>
            </div>
