...
to {
  ...
  animation: ${D} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,M=({toast:e})=>{let{icon:r,type:n,iconTheme:l}=e;return void 0!==r?"string"==typeof r?f.createElement(z,null,r):r:"blank"===n?null:f.createElement($,null,f.createElement(I,{...l}),"loading"!==n&&f.createElement(H,null,"error"===n?f.createElement(k,{...l}):f.createElement(T,{...l})))},ye=e=>`
...
`,Ae=(e,r)=>{let n=e.includes("top")?1:-1,[l,d]=A()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[ye(n),ge(n)];return{animation:r?`${w(l)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${w(d)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}};f.memo(({toast:e,position:r,style:n,children:l})=>{let d=e.height?Ae(e.position||r||"top-center",e.visible):{opacity:0},c=f.createElement(M,{toast:e}),m=f.createElement(Z,{...e.ariaProps},dist_f(e.message,e));return f.createElement(q,{className:e.className,style:{...d,...n,...e.style}},"function"==typeof l?l({icon:c,message:m}):f.createElement(f.Fragment,null,c,m))}),c=f.createElement,o.p=void 0,v=c,_=void 0,S=void 0,u`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`;var V=dist_c}},function(e){e.getEagerSharedForChunkId&&e.getEagerSharedForChunkId(459,e.initConsumes),e.getEagerRemotesForChunkId&&e.getEagerRemotesForChunkId(459,e.initRemotes),e.O(0,[888,179],function(){return e.own_remote.then(function(){return Promise.all([Promise.all(e.initRemotes),Promise.all(e.initConsumes)])}).then(function(){return e(e.s=3236)})}),_N_E=e.O()}]);