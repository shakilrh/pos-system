...
app.use(express.static(path.join(__dirname, '../frontend/build'))); // Adjust path to your frontend build directory
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, '../frontend/build', 'index.html')); // Adjust path to your frontend build directory
});
